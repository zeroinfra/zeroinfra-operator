...
import (
	...
	"github.com/zeroinfra/storage-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aeceded7.zeroinfra.github.com",
	...
	if err = (&controller.FileStorageReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "FileStorage")
		os.Exit(1)
	}
