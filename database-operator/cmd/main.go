...
import (
	...
	"github.com/zeroinfra/database-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4b12c939.zeroinfra.github.com",
	...
	if err = (&controller.MongoReplicaSetReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MongoReplicaSet")
		os.Exit(1)
	}
