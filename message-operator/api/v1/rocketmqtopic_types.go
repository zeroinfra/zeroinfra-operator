...
type RocketMQTopicSpec struct {
	...
	// Foo is an example field of RocketMQTopic. Edit rocketmqtopic_types.go to remove/update
...
type RocketMQTopic struct {
	...
	Spec   RocketMQTopicSpec   `json:"spec,omitempty"`
	Status RocketMQTopicStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RocketMQTopicList contains a list of RocketMQTopic.
