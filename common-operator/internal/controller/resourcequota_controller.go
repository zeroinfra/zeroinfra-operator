...
// +kubebuilder:rbac:groups=common.zeroinfra.github.com,resources=resourcequotas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=common.zeroinfra.github.com,resources=resourcequotas/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=common.zeroinfra.github.com,resources=resourcequotas/finalizers,verbs=update
