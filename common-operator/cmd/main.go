...
import (
	...
	"github.com/zeroinfra/common-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "338a6d25.zeroinfra.github.com",
	...
	if err = (&controller.InfraMonitorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "InfraMonitor")
		os.Exit(1)
	}
