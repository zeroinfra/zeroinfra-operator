...
// +kubebuilder:rbac:groups=model.zeroinfra.github.com,resources=inferences,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=model.zeroinfra.github.com,resources=inferences/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=model.zeroinfra.github.com,resources=inferences/finalizers,verbs=update
